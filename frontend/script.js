        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (originFilter) {
                originFilter.addEventListener('input', () => {
                    clearTimeout(searchTimer);
                    searchTimer = setTimeout(() => {
                        fetchCafes();
                    }, 400);
            ...
            mapToggleBtn.addEventListener('click', () => {
                ...
                if (mapIsVisible) {
                    ...
                    // Invalida o tamanho do Leaflet para renderizar corretamente após abrir a div
            ...
            resultsList.innerHTML = `
                <div class="col-span-full flex justify-center py-12">
                    <div class="animate-pulse flex flex-col items-center">
                        ...
                        <p class="text-gray-500 font-medium">Buscando inventário especializado...</p>
                    </div>
                </div>
            `;
            lucide.createIcons(); // Recria os ícones inseridos
        ...
        function renderResults(cafes) {
            ...
            cafes.forEach(cafe => {
                ...
                // Mapeia os grãos para tags estilizadas
            ...
            lucide.createIcons(); // Ativa os ícones gerados dinamicamente
        }
        ...
        function updateMarkers(cafes) {
            ...
            cafes.forEach((cafe) => {
                // Mock de coordenadas baseado em SP (apenas visual, já que não há lat/long no DB atual)
